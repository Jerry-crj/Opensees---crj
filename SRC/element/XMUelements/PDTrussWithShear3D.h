...
#ifndef PDTrussWithShear3D_h
#define PDTrussWithShear3D_h
...
#define ELE_TAG_PDTrussWithShear3D 7854688349

class PDTrussWithShear3D: public Element {

public:
	PDTrussWithShear3D();
	PDTrussWithShear3D(int tag, int node1, int node2, double a, NDMaterial* theMat);
	virtual ~PDTrussWithShear3D();
...
private:
	...
	double A;
	double L;
	Vector parallel, perpendicular1, perpendicular2;
