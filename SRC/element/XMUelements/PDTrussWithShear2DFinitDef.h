...
#ifndef PDTrussWithShear2DFinitDef_h
#define PDTrussWithShear2DFinitDef_h
...
#define ELE_TAG_PDTrussWithShear2DFinitDef 7854688349123

class PDTrussWithShear2DFinitDef: public Element {

public:
	PDTrussWithShear2DFinitDef();
	PDTrussWithShear2DFinitDef(int tag, int node1, int node2, double a, NDMaterial* theMat);
	virtual ~PDTrussWithShear2DFinitDef();
