...
extern void* OPS_TimoshenkoModified();
extern void* OPS_PDTrussWithShear2D();
extern void* OPS_PDTrussWithShear2DFinitDef();
extern void* OPS_PDTrussWithShear3D();
extern void* OPS_TimoThreeNodeCurveSec2D();
extern void* OPS_TimoFourNodeCurveSec2D();
extern void* OPS_TimoFourNodePlaneSec2D();
extern void* OPS_PDSlip2D();
extern void* OPS_PDSlip3D();
...
extern  void* OPS_ShearWall(void);


extern int TclModelBuilder_addTimoShenkoBeamColumn(ClientData clientData, Tcl_Interp* interp, int argc,
	...
	Domain* theTclDomain, TclModelBuilder* theTclBuilder)
{
	...
	else if (strcmp(argv[1], "timoModify") == 0) {

		void* theEle = OPS_TimoshenkoModified();
		if (theEle != 0)
			theElement = (Element*)theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	else if (strcmp(argv[1], "PDTrussWithShear2D") == 0) {
		void* theEle = OPS_PDTrussWithShear2D();
		if (theEle != 0)
			theElement = (Element*)theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	/*else if (strcmp(argv[1], "PDTrussWithShear2DFinitDef") == 0) {
		void* theEle = OPS_PDTrussWithShear2DFinitDef();
		if (theEle != 0)
			theElement = (Element*)theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	else if (strcmp(argv[1], "PDTrussWithShear3D") == 0) {
		void* theEle = OPS_PDTrussWithShear3D();
		if (theEle != 0)
			theElement = (Element*)theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	else if (strcmp(argv[1], "TimoThreeNodeCurveSec2D") == 0)
	{
		Element* theEle = (Element*)OPS_TimoThreeNodeCurveSec2D();
		if (theEle != 0)
			theElement = theEle;
		else {
			opserr << "TimoThreeNodeCurveSec2D -- unable to create element of type : " << argv[1] << endln;
			return TCL_ERROR;
		}
	}
	else if (strcmp(argv[1], "TimoFourNodeCurveSec2D") == 0)
	{
		Element* theEle = (Element*)OPS_TimoFourNodeCurveSec2D();
		if (theEle != 0)
			theElement = theEle;
		else {
			opserr << "TimoThreeNodeCurveSec2D -- unable to create element of type : " << argv[1] << endln;
	...
	else if (strcmp(argv[1], "TimoFourNodePlaneSec2D") == 0)
	{
		Element* theEle = (Element*)OPS_TimoFourNodePlaneSec2D();
		if (theEle != 0)
			theElement = theEle;
		else {
			opserr << "TimoFourNodePlaneSec2D -- unable to create element of type : " << argv[1] << endln;
			return TCL_ERROR;
		}
	}
	else if (strcmp(argv[1], "PDSlip2D") == 0) {
		Element* theEle = (Element*)OPS_PDSlip2D();
		if (theEle != 0)
			theElement = theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	else if (strcmp(argv[1], "PDSlip3D") == 0) {
		Element* theEle = (Element*)OPS_PDSlip3D();
		if (theEle != 0)
			theElement = theEle;
		else {
			opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
	...
	//else if (strcmp(argv[1], "ShearWall") == 0)
	//{
	//	Element *theEle = (Element*)OPS_ShearWall();
	//	if (theEle != 0)
	//		theElement = theEle;
	//	else {
	//		opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
