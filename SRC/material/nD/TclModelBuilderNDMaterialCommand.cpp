...
extern void* OPS_TimoToQuadMat(void);
extern void* OPS_QuadToTimoMat(void);
extern void* OPS_ASIConcrete(void);
extern void* OPS_CombinedUniaxialTimoMat(void);
extern void* OPS_MCTM(void);
	...
	TCL_Char** argv, TclModelBuilder* theTclBuilder)
{
	...
	else if ((strcmp(argv[1], "MCTM") == 0))
	{
		void* theMat = OPS_MCTM();
		if (theMat != 0)
			theMaterial = (NDMaterial*)theMat;
		else
			return TCL_ERROR;
	}
	else if ((strcmp(argv[1], "CombinedUniaxialTimoMat") == 0))
	{
		void* theMat = OPS_CombinedUniaxialTimoMat();
		if (theMat != 0)
			theMaterial = (NDMaterial*)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "TimoToQuadMat") == 0))
	{
		void* theMat = OPS_TimoToQuadMat();
		if (theMat != 0)
			theMaterial = (NDMaterial*)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "QuadToTimoMat") == 0))
	{
		void* theMat = OPS_QuadToTimoMat();
		if (theMat != 0)
			theMaterial = (NDMaterial*)theMat;
		else
			return TCL_ERROR;
	...
	else if ((strcmp(argv[1], "ASIConcrete") == 0))
	{
		void* theMat = OPS_ASIConcrete();
		if (theMat != 0)
			theMaterial = (NDMaterial*)theMat;
		else
			return TCL_ERROR;
