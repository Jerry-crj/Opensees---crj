...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/TimoToQuadMat.h,v $
                                                                      
// Written: fmk
// Created: 03/06
//
// Description: This file contains the class definition for 
// TimoToQuadMat. TimoToQuadMat is based on an f2c of the FEDEAS material
// Concr2.f which is:
/*-----------------------------------------------------------------------
...
#ifndef TimoToQuadMat_h
#define TimoToQuadMat_h

#include <Vector.h>
#include <Matrix.h>
#include <NDMaterial.h>

class TimoToQuadMat : public NDMaterial
{
  public:
    TimoToQuadMat(int tag, NDMaterial * matTag);

    TimoToQuadMat(void);

    ~TimoToQuadMat();

    const char *getType(void) const {return "TimoToQuadMat";};
