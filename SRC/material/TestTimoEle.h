...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/ASCCTEST.h,v $
                                                                      
// Written: fmk
// Created: 03/06
//
// Description: This file contains the class definition for 
// ASCCTEST. ASCCTEST is based on an f2c of the FEDEAS material
// Concr2.f which is:
/*-----------------------------------------------------------------------
...
class ASCCTEST : public NDMaterial
{
  public:
    ASCCTEST(int tag, NDMaterial * matTag);

    ASCCTEST(void);

    ~ASCCTEST();

    const char *getType(void) const {return "ASCCTEST";};
