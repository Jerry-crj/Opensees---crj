...
#ifndef TrialElementRecorder_h
#define TrialElementRecorder_h

#define RECORDER_TAGS_TrialElementRecorder 94561215
...
class TrialElementRecorder : public Recorder
{
  public:
    TrialElementRecorder();
    TrialElementRecorder(const ID *eleID, 
		    const char **argv, 
		    int argc,
		    bool echoTime, 
		    Domain &theDomain, 
    ...
    virtual const char* getRecorderType(void) { return "TrialElementRecorder"; };
