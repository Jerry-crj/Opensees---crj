...
# 定义单元
element zeroLength 5 5 15 -mat 10 10 10 -dir 1 2 3
element zeroLength 6 6 16 -mat 10 10 10 -dir 1 2 3
element zeroLength 7 7 17 -mat 10 10 10 -dir 1 2 3
element zeroLength 8 8 18 -mat 10 10 10 -dir 1 2 3
...
recorder Node -file node3React.out -time -node 3 -dof 1 2 3 reaction
recorder Node -file node4React.out -time -node 4 -dof 1 2 3 reaction
recorder Node -file node5Displ.out -time -node 5 -dof 1 2 3 disp
recorder Node -file node6Displ.out -time -node 6 -dof 1 2 3 disp
recorder Node -file node7Displ.out -time -node 7 -dof 1 2 3 disp
recorder Node -file node8Displ.out -time -node 8 -dof 1 2 3 disp
