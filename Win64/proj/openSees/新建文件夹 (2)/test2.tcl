...
recorder Node    -file displ2.out   -node 3 4 -dof 1 2 disp;
recorder Element -file stress2.out  -ele  1  material 1 stress
recorder Element -file strain2.out  -ele  1  material 1 strain
recorder Element -file dmg2.out     -ele  1  material 1 dmgfct
recorder Element -file stiff2.out   -ele  1  material 1 tangent
...
integrator LoadControl  -1.0e-10
algorithm Newton 
numberer RCM
analysis Static
analyze   1
